...
function aplicarConfig() {
  ...
  setText("decisao-titulo", C.copy.decisao_titulo);
  setText("decisao-subtitulo", C.copy.decisao_subtitulo);
  setText("decisao-intro", C.copy.decisao_intro);
  document.getElementById("decisao-bullets").innerHTML = C.copy.decisao_bullets.map(function(item) {
    return "<li>" + escapeHtml(item) + "</li>";
  }).join("");
  setText("decisao-prova-titulo", C.copy.decisao_prova_titulo);
  setText("decisao-prova-texto", C.copy.decisao_prova_texto);
  setText("decisao-cta-text", C.copy.decisao_cta);
